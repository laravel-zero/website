...
<section class="container max-w-2xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <p class="text-lg">An elegant starting point for your console application.<br class="hidden sm:block">Built on top of the Laravel components.</p>
        ...
        <img class="mx-auto mb-6 lg:mb-0" src="/assets/img/logo-large.png" alt="{{ $page->siteName }} large logo">
    </div>
    ...
    <div class="flex flex-col -mx-2 items-center justify-center md:items-start md:flex-row md:-mx-4 md:justify-between">
        <div class="flex flex-col w-full mb-8 mx-3 px-2 md:w-1/3">
            ...
            <h3 id="intro-laravel" class="text-2xl text-blue-darkest mb-0">Strong <br>Foundation</h3>

            <p>It’s built on top of the latest release of Laravel. Using Laravel Zero, you are free to take advantage of all of Laravel's great features.</p>
        </div>
